...
class LocalParlantEngine:
    ...
    async def run(self, user_text: str) -> str:
        ...
        planner_prompt = (
            ...
            + "- If the seller asks to upload products, add many products, or onboard items in bulk, use share_upload_link.\n"
            + "- If the seller asks to see or browse their catalogue/inventory, use share_catalogue_link.\n"
            + "- If the seller asks to see, view, or check orders, use share_orders_link.\n"
            + "- If a customer asks to place an order and we don't yet know their name, ask for it; once they reply with a name, call set_customer_name with it before create_order.\n"
